...
menu = {
    "Đồ ăn": {
        "Pizza Hải Sản": 150000,"Pizza phô mai": 350000,
        "Mì Ý Bò Bằm": 95000,
        "Burger Gà": 35000,
        "Salad Trộn": 50000,
        "Bít tết Bò Mỹ": 250000,
        "Sườn nướng BBQ": 180000,
        "Cánh gà sốt bơ tỏi": 65000,
        "Cánh gà sốt tiêu đen": 65000,
        "Lẩu cá nấm": 200000,
    ...
    "Thức uống": {
        ...
        "Sinh tố Bơ": 45000,
        "Nước ép cam": 40000,
        "Coffee Coldbrew chanh vàng": 55000,
        "Trà trái cây": 55000,
    },
}
...
if page == "🍽️ Order":
    st.title("🍽️ Hệ thống Order Nhà Hàng_CTU")
